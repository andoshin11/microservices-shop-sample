...
/*
Package sampleshop is a reverse proxy.
...
func RegisterProductCatalogServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ProductCatalogServiceServer) error {
	...
	mux.Handle("GET", pattern_ProductCatalogService_ListProducts_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ProductCatalogService_ListProducts_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_ProductCatalogService_ListProducts_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterProductCatalogServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ProductCatalogServiceClient) error {
	...
	mux.Handle("GET", pattern_ProductCatalogService_ListProducts_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ProductCatalogService_ListProducts_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_ProductCatalogService_ListProducts_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "productCatalog", "products"}, "", runtime.AssumeColonVerbOpt(true)))
)
